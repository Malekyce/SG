...
def main():
    ...
    if choice == "Home":
        ...
        st.markdown("Select the desired demand (MW):")
        user_input = st.slider("Adjust Demand", min_value=0, max_value=1000, value=500)
        st.markdown(f"Selected Demand: {user_input} MW")
